  ...
  return (
    <section id="about-me" className="space-y-3">
      ...
      <p>
        ...
        something I really had great affinity with. My passion for computer and
        gaming, which began at the age of 7, greatly contributed to my journey
        into programming. I almost didn't want to go to college due to financial
        issues but I luckily got into a scholarship in{" "}
        <a
